    ...
    <main className="flex items-center justify-center pt-16 pb-4">
      <div className="flex-1 flex flex-col items-center gap-16 min-h-0">
        ...
        <div className="max-w-[300px] w-full space-y-6 px-4">
          ...
          <section className="rounded-3xl border border-gray-200 p-6 space-y-4">
            <Form
              method="post"
            ...
            >
              <input
                ...
                placeholder="Name"
                required
                className="w-full h-10 px-3 rounded-lg border border-gray-200 focus:ring-1 focus:ring-blue-500"
              />
              <input
                name="email"
                type="email"
              ...
              {guestBookError && (
                <p className="text-red-500">{guestBookError}</p>
              )}
            </Form>
